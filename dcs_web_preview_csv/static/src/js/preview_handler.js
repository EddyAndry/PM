...
odoo.define('dcs_preview_csv.PreviewHandler', function (require) {
"use strict";

var ajax = require('web.ajax');
var core = require('web.core');

var PreviewHandler = require('dcs_preview.PreviewHandler');
...
var CSVHandler = PreviewHandler.BaseHandler.extend({
	cssLibs: [
		'/dcs_web_utils/static/lib/pikaday/pikaday.css',
		'/dcs_web_utils/static/lib/handsontable/handsontable.css',
    ],
    jsLibs: [
        '/dcs_web_utils/static/lib/PapaParse/papaparse.js',
        '/dcs_web_utils/static/lib/numbro/numbro.js',
        '/dcs_web_utils/static/lib/pikaday/pikaday.js',
        '/dcs_web_utils/static/lib/handsontable/handsontable.js',
    ],
