...
odoo.define('dcs_preview_image.PreviewHandler', function (require) {
"use strict";
...
var ImageHandler = PreviewHandler.BaseHandler.extend({
	cssLibs: [
		'/dcs_web_utils/static/lib/imageviewer/imageviewer.css',
    ],
    jsLibs: [
        '/dcs_web_utils/static/lib/imageviewer/imageviewer.js',
    ],
