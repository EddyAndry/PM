...
class Directory(models.Model):
    ...
    tags = fields.Many2many(
        comodel_name='dcs_dms.tag',
        relation='dcs_dms_directory_tag_rel', 
        column1='did',
        column2='tid',
        string='Tags')
    ...
    parent_directory = fields.Many2one(
        comodel_name='dcs_dms.directory', 
    ...
    user_stars = fields.Many2many(
        ...
        relation='dcs_dms_directory_star_rel',
        column1='did',
        column2='uid',
        string='Stars')
    ...
    def _inverse_starred(self):
        starred_records = self.env['dcs_dms.directory'].sudo()
        not_starred_records = self.env['dcs_dms.directory'].sudo()
        for record in self:
    ...
    def copy(self, default=None):
        ...
        if self.is_root_directory:
            ...
            parent_directory = self.env['dcs_dms.directory'].sudo().browse(default['parent_directory'])
