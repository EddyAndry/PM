...
class Settings(models.Model):
    ...
    _name = 'dcs_dms.settings'
    _description = "MuK Documents Settings"
    _inherit = 'dcs_dms.model'
    ...
    def _search_top_directories(self, operator, operand):
        directories = self.env['dcs_dms.directory'].search([('name', operator, operand)])
    ...
    def _search_top_files(self, operator, operand):
        files = self.env['dcs_dms.file'].search([('name', operator, operand)])
