...
odoo.define('dcs_dms_dialogs.DocumentDropDialog', function(require) {
"use strict";
...
var DocumentDropDialog = Dialog.extend({
	cssLibs: [
        '/dcs_web_utils/static/lib/dropzone/dropzone.css',
    ],
    jsLibs: [
        '/dcs_web_utils/static/lib/dropzone/dropzone.js',
    ],
