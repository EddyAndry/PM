...
odoo.define('dcs_dms_dialogs.DocumentDirectoryInfoDialog', function(require) {
"use strict";

var core = require('web.core');

var DocumentInfoDialog = require('dcs_dms_dialogs.DocumentInfoDialog');
...
var DocumentDirectoryInfoDialog = DocumentInfoDialog.extend({
    init: function (parent, options) {
        ...
        this._super(parent, _.extend({}, {
            ...
            qweb: "dcs_dms.DocumentDirectoryInfoDialog",
        }, this.options));
    },
});
