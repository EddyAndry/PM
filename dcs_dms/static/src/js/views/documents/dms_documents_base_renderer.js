...
odoo.define('dcs_dms_views.DocumentsRenderer', function(require) {
"use strict";
...
var DocumentsRenderer = Widget.extend({
	xmlDependencies: [
		'/dcs_dms/static/src/xml/dms_documents_tree.xml'
	],
	cssLibs: [
        '/dcs_web_utils/static/lib/jsTree/themes/proton/style.css',
    ],
    jsLibs: [
        '/dcs_web_utils/static/lib/jsTree/jstree.js',
    ],
    template: 'dcs_dms.DocumentTree',
    ...
    start: function() {
    	...
    	this.$tree.on('open_node.jstree', function (e, data) {
    		if(data.node.data && data.node.data.odoo_model === "dcs_dms.directory") {
