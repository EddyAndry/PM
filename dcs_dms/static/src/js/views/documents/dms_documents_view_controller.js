...
odoo.define('dcs_dms_views.DocumentsViewController', function(require) {
"use strict";
...
var DocumentsController = require('dcs_dms_views.DocumentsController');
var DocumentFileInfoDialog = require('dcs_dms_dialogs.DocumentFileInfoDialog');
var DocumentDirectoryInfoDialog = require('dcs_dms_dialogs.DocumentDirectoryInfoDialog');
var DocumentDropFileDialog = require('dcs_dms_dialogs.DocumentDropFileDialog');
var DocumentDropFilesDialog = require('dcs_dms_dialogs.DocumentDropFilesDialog');
    	...
    	menu.create = {
			...
			submenu: {
				directory: {
					...
					icon: "fa fa-folder-o",
					action: function(data) {
						self._createNode(node, "dcs_dms.directory");
					},
					_disabled: function (data) {
		    			return !node.data.perm_create;
	    			},
				...
				file : {
					...
					icon: "fa fa-file-o",
					action: function(data) {
						self._createNode(node, "dcs_dms.file");
					},
					_disabled: function (data) {
		    			return !node.data.perm_create;
	    			},
