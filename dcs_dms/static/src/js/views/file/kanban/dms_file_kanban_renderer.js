...
odoo.define('dcs_dms_views.FileKanbanRenderer', function (require) {
"use strict";
...
var FileKanbanColumn = require('dcs_dms_views.FileKanbanColumn');
var FileKanbanRecord = require('dcs_dms_views.FileKanbanRecord');
    ...
    _renderView: function () {
    	...
    	if(!config.device.isMobile && _.some(_.keys(this.kanban_sidebar), function(key) {
    		...
    		this.sidebar = $("<div>", {
	    		...
	    		html: $(QWeb.render('dcs_dms.KanbanFileSidebar', {
	                widget: this,
