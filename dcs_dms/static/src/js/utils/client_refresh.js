...
odoo.define('dcs_dms_client_refresh.channel', function (require) {
"use strict";
...
WebClient.include({
    refresh: function(message) {
    	...
    	if(session.uid !== message.uid && widget && action && 
    			action.action_descr.tag === "dcs_dms_views.documents" && (
    			message.model === 'dcs_dms.directory' ||
    			message.model === 'dcs_dms.file')) {
