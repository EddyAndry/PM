...
odoo.define('dcs_preview_msoffice.PreviewHandler', function (require) {
"use strict";
...
var ExcelHandler = PreviewHandler.BaseHandler.extend({
    ...
    jsLibs: [
        '/dcs_web_utils/static/lib/jQueryBinaryTransport/jquery-binarytransport.js',
        '/dcs_web_utils/static/lib/SheetJS/xlsx.js',
